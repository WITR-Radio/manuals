...
% INCLUDE GRAPHIC OF LOGGER HERE (where did I put this?)
...
% INSERT IMAGE OF RD 2ND PANEL HERE (where is this?)
...
\begin{enumerate}
    ...
    \item Select the new log you just created and click ``Edit.'' This window
        ...
        \includegraphics[width=\textwidth]{images/rivendell-editlogs.jpg}
        % TODO: fix alignment
...
% INCLUDE GRAPHIC OF DJ PAGE TABLE OF CONTENTS HERE (where is this?)
...
% INCLUDE TRIPLET GRAPHICS OF PEOPLE IN STUDIO X HERE
...
% DRAW TIKZ DIAGRAM OF SHOW, MUSIC CHOICES, MIC BREAKS, STYLE HERE
...
% INCLUDE GRAPHIC OF CD REVIEW GUIDELINES HERE (where is this?)
...
Make sure to ask your trainer to add you to the ``WITR 89.7'' group on the Book
of Faces, if you haven't already been added.  Try to hang out in the station
when you have free time.  We want to get to know you, and the more you talk with
other DJs, the better you'll get on air as well.  Just keep in mind: we expect
everyone to be extremely professional and serious at all times\dots
