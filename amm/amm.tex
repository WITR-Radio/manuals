...
% If you can't figure out how to get LaTeX working on your computer, just make
% commits to the dev branch of the repository.  Travis CI will automatically
% compile your commit and create a new release tagged with the date, time, and
% commit hash of your changes, which you can then download and view.
%
% That system is great for quick, one-off changes, but if you need to tweak
% something, compile, and check it repeatedly, installing LaTeX on your machine
% is really worth it.  It takes about 2 minutes for Travis to run the build, so
% the time investment now will be really worth it.
...
% What background do we use for the title page?
